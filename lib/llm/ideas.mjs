...
- COLDEST-INDUSTRY SHORT: the industry the global situation is HURTING most -> SHORT its WEAKEST name. Use INDUSTRY_HEAT (most-negative mean), SECTOR_LAGGING / classification=lagging|reversal-down, and NAME_LAGGARDS as the trigger — the mirror of the leading-sector LONG.
- DISTRIBUTION SHORT: confirmed technical BREAKDOWN (+ rich valuation when available) -> SHORT. A name in TECH_BREAKDOWNS (price < MA50 AND < MA200, falling RSI, near 52w LOW on rising RVOL) that is also a sector laggard is a momentum short, the direct mirror of the breakout LONG. TECH_BREAKDOWNS membership is the required structural trigger here.
